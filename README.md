...
The Kubernetes cluster and any other Azure cloud resource should be previously provisioned using [these](https://github.com/teamdigitale/dpt-services-infra-tf-live) Terraform scripts.
